...
public class AdapterHelper extends RecyclerView.ViewHolder
{
    ...
    {
        AdapterHelper.imagehandler = imagehandler;
    }
     ...
     *
     * @param viewId         The view id.
     * @param requestBuilder The Picasso request builder. (e.g. Picasso.with(context).load
     *                       (imageUrl))
     * @return The void for chaining.
     */
    public void setImageBuilder(int viewId, RequestCreator requestBuilder)
    {
        ImageView view = retrieveView(viewId);
